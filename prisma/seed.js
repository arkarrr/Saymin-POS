...
async function main() {
  ...
  const rolesData = [
    ...
    { name: 'MANAGER',    displayName: 'Manager',    description: 'Manages products, stock and reports' },
    { name: 'CASHIER',    displayName: 'Cashier',    description: 'Handles daily sales and payments' },
    { name: 'INVENTORY',  displayName: 'Inventory',  description: 'Manages stock operations' },
  ...
  const permissionsData = [
    // Products & inventory
    { key: 'MANAGE_PRODUCTS',        description: 'Create/update/delete products and prices' },
    { key: 'VIEW_STOCK',             description: 'View stock levels' },
    { key: 'ADJUST_STOCK',           description: 'Perform stock adjustments' },
    { key: 'MANAGE_PURCHASES',       description: 'Create and manage purchase orders/stock-in' },

    // Sales & cash
    { key: 'CREATE_SALE',            description: 'Create sales in POS' },
    { key: 'APPLY_DISCOUNT',         description: 'Apply normal discounts' },
    { key: 'APPLY_HIGH_DISCOUNT',    description: 'Apply large discounts (e.g. >20%)' },
    { key: 'MANAGE_PAY_LATER',       description: 'Create and manage pay-later/credit sales' },
    ...
    { key: 'VIEW_ALL_SHIFTS',        description: 'View all cashiers’ shift summaries' },

    // Customers & suppliers
    { key: 'MANAGE_CUSTOMERS',       description: 'Create/update customer records' },
    { key: 'VIEW_CUSTOMER_BALANCES', description: 'View customer credit balances' },
    ...
    // System & settings
    { key: 'MANAGE_USERS',           description: 'Create/update users and assign roles' },
    { key: 'MANAGE_SETTINGS',        description: 'Update system settings and parameters' },
  ];
